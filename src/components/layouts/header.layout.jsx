  ...
  return (
    <header className="bg-brand py-2">
        <div className="container">
            <div id="logo-wrapper">
                <a href="#" aria-label="Logo of Booking.com">
                <img
                    width={144}
                    height={24}
        ...
        <div id="auth" className="flex gap-2 justify-center items-center">
            <Button className="bg-white cursor-pointer border-primary text-primary rounded-sm hover:bg-white/95">Register</Button>
            <Button className="bg-white cursor-pointer border-primary text-primary rounded-sm hover:bg-white/95">Login</Button>
